              ...
              {loading ? (
                ...
                candidates.map((c, i) => (
                  <tr key={c.candidate_id} onClick={() => handleRowClick(c.candidate_id)} style={{cursor: 'pointer'}}>
                    ...
                    <td className={styles.nameCell}>{c.full_name}</td>
                    <td>
                    ...
                    <td><span className={styles.degreeText}>{c.degree || '-'}</span></td>
                    <td>
                      <div className={styles.roleCell}>
                        <span className={styles.deptText}>{c.department}</span>
                        <span className={styles.posText}>{c.position}</span>
                      </div>
                    </td>
                    <td>
